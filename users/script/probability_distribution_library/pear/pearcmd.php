...
if ('C:\Program Files (x86)\Ampps\php-5.6\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('C:\Program Files (x86)\Ampps\php-5.6\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
