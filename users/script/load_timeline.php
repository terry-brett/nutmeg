...
foreach ($messages as $item){
	...
	<img style=\"margin-left: 300px\" src='" . $file. "' class='img-polaroid' alt='Img' width:='600px' height='600px'>";
	}
	else {
		$content_str .= "
		<style>
		...
		<img style=\"margin-left: 100px\" src='" . $file. "' class='img-polaroid' alt='Img' width:='700px'>";
	}
		...
		<div class="container">
			<div class="column" style="width: 70%;">
				<table>
					<tr>
						...
						<td><img src="https://avatars.dicebear.com/v2/bottts/' . get_item_username($item) . '.svg" width="70" height="70" style="background: white; margin-left: 7px; margin-top: 5px; border-radius: 50%"/></td>
						<td style="padding:0 15px 0 15px;">
							<p><strong>Message from  ' . get_item_username($item) . ' </strong></p>
			...
			<div id="message_icon" class="column" style="width: 15%;">
				<div class="text-container">
					<a class="btn" id="open_message_btn' . $i . '" style="text-decoration:none;" href="#">View</a>
				</div>
			</div>
		</div>
	</div>
